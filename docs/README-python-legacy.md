> **⚠️ Legacy (v1, Python).** This is the archived README of the old embeddable-Python build (`install.bat` / `run.bat`, port 8765). Dub Studio v2 is a fully native Rust + C++ rewrite — see the current **[README](../README.md)**.
