...
- **Авто-обновление** — приложение само проверяет новую версию и ставит её по кнопке
- **Превью видео при загрузке** — первый кадр выбранного ролика прямо в зоне загрузки на главном экране
