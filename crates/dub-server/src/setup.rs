...
//! библиотеки) + диагностика их наличия на диске + фоновая автозакачка одной кнопкой. Цель приказа
//! юзера: «приложение само предлагает скачать, я только да нажимаю» — свести ручную установку к
